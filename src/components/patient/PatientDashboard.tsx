  ...
  return (
    <section className="mb-4" aria-label="דיווח דחוף מהדשבורד">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-4 px-4 rounded-2xl font-black text-red-950 text-base sm:text-lg border-2 border-red-600 bg-white hover:bg-red-50 transition-colors shadow-sm"
      >
