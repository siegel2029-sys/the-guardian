...
const CHAIN_BY_PRIMARY: Partial<Record<BodyArea, BodyArea[]>> = {
  ...
  wrist_right: ['elbow_right', 'forearm_right', 'shoulder_right', 'hand_right'],
  wrist_left: ['elbow_left', 'forearm_left', 'shoulder_left', 'hand_left'],
  hand_right: ['wrist_right', 'forearm_right', 'elbow_right'],
  hand_left: ['wrist_left', 'forearm_left', 'elbow_left'],
  forearm_right: ['wrist_right', 'elbow_right', 'hand_right'],
  forearm_left: ['wrist_left', 'elbow_left', 'hand_left'],
  ...
  ankle_right: ['shin_right', 'knee_right', 'foot_right'],
  ankle_left: ['shin_left', 'knee_left', 'foot_left'],
  foot_right: ['ankle_right', 'shin_right', 'knee_right'],
  foot_left: ['ankle_left', 'shin_left', 'knee_left'],
